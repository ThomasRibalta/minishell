...
/*   Updated: 2024/06/29 23:41:44 by jedurand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					process_command_token(t_astnode **root, t_astnode **cmd,
							t_token *token);
...
int						process_token(t_token **token, t_astnode **root,
							t_astnode **cmd, t_redirections *redirs);
